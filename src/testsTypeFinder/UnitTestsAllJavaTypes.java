...
public class UnitTestsAllJavaTypes {
	...
	public void testNestedInAnonymousClass() {
	  ...
	  List<String> correctOutput = new ArrayList<String>();
	  correctOutput.add("Anonymous Types. Declarations found: 2; references found: 0.");
	  correctOutput.add("Nested Types. Declarations found: 2; references found: 2.");
	...
	public void testNestedClass() {
	  ...
	  List<String> correctOutput = new ArrayList<String>();
	  correctOutput.add("Nested Types. Declarations found: 3; references found: 3.");
	  correctOutput.add("Normal Types. Declarations found: 1; references found: 1.");
	...
	public void testLocalClass() {
		  ...
		  correctOutput.add("Normal Types. Declarations found: 1; references found: 0.");
